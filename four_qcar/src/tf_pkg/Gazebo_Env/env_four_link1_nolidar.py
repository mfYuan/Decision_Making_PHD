...
class envmodel1():
    ...
    def get_env(self):
        ...
        selfstate.append(self.v2)
        selfstate.append(self.v4)
        selfstate.append(self.v3)

        # print(sensor_info[-8:])

        env_info.append(selfstate)
        #print("The state is:{}".format(selfstate))
    ...
    def set_velocity(self, v2, v3, v4, s2, s3, s4):
        ...
        if s2 == '1':
            if (self.robotstate2[2] > 0 and self.robotstate2[2] < 0.25):
                self.v2 = 1
            elif (self.robotstate2[2] > 0.25 and self.robotstate2[2] < 0.45):
                self.v2 = 2
            elif self.robotstate2[2] > 0.45:
                self.v2 = 3
        else:
            self.v2 = 0
        if s3 == '1':
            if (self.robotstate3[2] > 0 and self.robotstate3[2] < 0.25):
                self.v3 = 1
            elif (self.robotstate3[2] > 0.25 and self.robotstate3[2] < 0.45):
                self.v3 = 2
            elif self.robotstate3[2] > 0.45:
                self.v3 = 3
        else:
            self.v3 = 0
        if s4 == '1':
            if (self.robotstate4[2] > 0 and self.robotstate4[2] < 0.25):
                self.v4 = 1
            elif (self.robotstate4[2] > 0.25 and self.robotstate4[2] < 0.45):
                self.v4 = 2
            elif self.robotstate4[2] > 0.45:
                self.v4 = 3
        else:
            self.v4 = 0
