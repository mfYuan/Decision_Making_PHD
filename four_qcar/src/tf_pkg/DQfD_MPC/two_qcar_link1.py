...
class DQN1:
    def __init__(self):
        ...
        self.load_path = '/home/sdcnlab025/ROS_test/four_qcar/src/tf_pkg/DQfD_MPC/saved_networks/two_qcar_links_2023-06-14_train1/qcar1/7019'
        #'/home/sdcnlab025/ROS_test/four_qcar/src/tf_pkg/DQfD_MPC/saved_networks/two_qcar_links_2023-06-13_train1/qcar1/1000'
        #'/home/sdcnlab025/ROS_test/trained model/saved_networks/two_qcar_links_2021-08-04_train1/qcar1/6350' # Level1-New
        ...
        self.Num_batch = 32
        #self.Replay_memory = []
        self.Replay_memory = np.empty((0, 5), dtype=np.float32)
        ...
        # Parameter for LSTM
        self.Num_dataSize = 1171  # 360 sensor size + 2 self state size + 3 velocity
    ...
    def Experience_Replay(self, state, action, reward, next_state, terminal):
        with graph1.as_default():
            ...
            if len(self.Replay_memory) >= self.Num_replay_memory:
                self.Replay_memory = np.delete(
                    self.Replay_memory, (0), axis=0)  # delete first row
            ...
            if self.progress == 'Observing':
                ...
                self.Replay_memory = np.append(self.Replay_memory, np.array(
                    [[state, action, reward, next_state, terminal]]), axis=0)
    ...
    def accelerate_new(self, desired_v, pid_output, action_qcar1):
        self.env.accel_new_old(desired_v, pid_output, action_qcar1)
