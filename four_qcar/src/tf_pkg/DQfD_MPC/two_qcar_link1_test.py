...
class DQN1:
    def __init__(self):
        ...
        self.load_path1 = '/home/sdcnlab025/ROS_test/four_qcar/src/tf_pkg/scripts/saved_networks/two_qcar_links_2021-08-04_train1/qcar1/6350' # Level1-New
        self.load_path2 = '/home/sdcnlab025/ROS_test/four_qcar/src/tf_pkg/scripts/saved_networks/two_qcar_links_2021-08-07_train1/qcar1/5850' # level2-New
        ...
        #self.load_path = '/home/sdcn/four_qcar/src/tf_pkg/scripts/saved_networks/Adpative/9900'# Adpative-New
        self.load_path1 = '/home/sdcnlab025/ROS_test/four_qcar/src/tf_pkg/Revision testing/saved/Level-1/qcar1/6350' # Level1-New
        self.load_path2 = '/home/sdcnlab025/ROS_test/four_qcar/src/tf_pkg/Revision testing/saved/Level-2/qcar1/5850' # level2-New
        self.load_path = '/home/sdcnlab025/ROS_test/four_qcar/src/tf_pkg/Revision testing/saved/Adapative/qcar1/4050'# Adp-New
        self.step = 1
        self.score = 0
        self.episode = 0
        ...
        # Parameter for LSTM
        self.Num_dataSize = 1171#371  # 1160 sensor size + 2 self state size + 3 velocity
    ...
    def get_progress(self, step, Epsilon):
        if self.isTraining == False:
            ...
            if self.Epsilon > self.Final_epsilon:
                Epsilon -= 0.00001/(1/self.Start_epsilon)  # 1.0/self.Num_training
    ...
    def update_information(self):
        ...
        self.collision_with = env_info[-3]
    ...
    def new_environment(self):
        ...
        if self.collision_with == 2:
            color = 'b'
        elif self.collision_with == 3:
            color = 'g'
        elif self.collision_with == 4:
            color = 'y'
        else:
            color = 'r'
        plt.scatter(self.episode, self.score, c=color)
        plt.xlabel("Episode")
        plt.ylabel("Reward")
