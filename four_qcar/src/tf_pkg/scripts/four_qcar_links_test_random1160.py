...
from two_qcar_link1_test1160 import DQN1
from two_qcar_link2_1160 import DQN2
from two_qcar_link3_1160 import DQN3
from two_qcar_link4_1160 import DQN4
    ...
    def main(self):
        ...
        while True:
            ...
            if self.step_for_newenv == self.MAXSTEPS or (one and two and three and four):
                ...
                self.level_qcar1 = str(np.random.choice([1,2,3]))
