...
from gazebo_env_D3QN_PER_two_qcar_link1_test import envmodel1
...
class DQN1:
	...
	self.path = str(5)
        ...
        while True:
            ...
            #omega_cmd = env.loop()#qcarx_dict[action_in][1]#env.self.calculateTwistCommand()#qcarx_dict[action_in][1]
            cmd[0] = v_cmd
            #cmd[1] = omega_cmd
            env.step(cmd)
	    time.sleep(0.05)	    
