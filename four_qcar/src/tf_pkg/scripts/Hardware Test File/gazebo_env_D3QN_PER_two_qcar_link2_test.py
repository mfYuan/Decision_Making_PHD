...
class envmodel2():
	...
	self.agentrobot2 = 'qcar2'
        ...
        self.rearPose = rospy.Subscriber('/' + self.agentrobot2 + '/rear_pose', PoseStamped, self.pose_cb, queue_size=1)
	...
	self.pub2 = rospy.Publisher('/' + self.agentrobot1 + '/ackermann_cmd', AckermannDriveStamped, queue_size=10)
	...
	self.step([0.0, 0.0])
        ...
        print("[Link2] The environment has been reset!")     
        time.sleep(1.0)
