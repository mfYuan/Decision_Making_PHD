...
class DQN:
	...
	self.Final_epsilon	= 0.1
        ...
        link1.update_parameters(self.Num_start_training, self.Num_training, self.Num_test, self.learning_rate, self.Gamma, self.Epsilon, self.Final_epsilon, self.MAXEPISODES)
        link2.update_parameters(self.Num_start_training, self.Num_training, self.Num_test, self.learning_rate, self.Gamma, self.Epsilon, self.Final_epsilon, self.MAXEPISODES)
        link3.update_parameters(self.Num_start_training, self.Num_training, self.Num_test, self.learning_rate, self.Gamma, self.Epsilon, self.Final_epsilon, self.MAXEPISODES)        
    ...
    def main(self):
        ...
        while True:
            ...
            link2.get_progress(self.step, self.Epsilon) # This can also return link2's progress if needed
            link3.get_progress(self.step, self.Epsilon) # This can also return link3's progress if needed
