...
class DQN:
    def __init__(self):
        ...
        self.d = 15.0 ##### (default 15.0)

        # Define the step for updating the environment
        self.MAXSTEPS    = 300 ##### (default 300)
        self.MAXEPISODES = 500 ##### (default 500)
    ...
    def init_sess(self):
	    ...
	    saver = tf.train.import_meta_graph(self.load_path + "/model.ckpt.meta") ##### NEW
