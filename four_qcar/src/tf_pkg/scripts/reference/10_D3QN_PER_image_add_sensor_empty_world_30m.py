...
#sys.path.insert(1, '~/DRL_Path_QCar_MY/src/qcar/nodes')

#from ackermann_controller import _AckermannCtrlr
...
action_dict = {0: [0.0, 0], 1: [1.0, 0], 2: [3.0, 0.0]}
...
class DQN:
    ...
    def main(self):
        ...
        env.reset_env(start=[16, 0], goal=[randposition[1][0], randposition[1][1]])
        ...
        while True:
            ...
            omiga_cmd = env.loop()#action_dict[action_in][1]#env.self.calculateTwistCommand()#action_dict[action_in][1]
            cmd[0]=v_cmd
            cmd[1]=omiga_cmd
            env.step(cmd)
