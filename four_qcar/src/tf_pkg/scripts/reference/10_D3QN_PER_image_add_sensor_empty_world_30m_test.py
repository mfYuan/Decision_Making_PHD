...
class DQN:
    def __init__(self):
        ...
        self.load_path = '/home/sdcnlab/DRL_Path_QCar_MY/src/tf_pkg/scripts/saved_networks/10_D3QN_PER_image_add_sensor_empty_world_30m_2020-12-14'
    ...
    def init_sess(self):
	    ...
	    saver = tf.train.import_meta_graph(self.load_path + "/model.ckpt.meta")
    ...
    def main(self):
        ...
        filename1 = '/home/sdcnlab/DRL_Path_QCar_MY/src/tf_pkg/scripts/12_start_point_x.txt'
        with open(filename1, 'r') as f:
            lines = f.readlines()
            for line in lines:
                Start_x = [float(s) for s in line.split()]
                start_x.append(Start_x[0])
        filename2 = '/home/sdcnlab/DRL_Path_QCar_MY/src/tf_pkg/scripts/12_start_point_y.txt'
        with open(filename2, 'r') as f:
            lines = f.readlines()
            for line in lines:
                Start_y = [float(s) for s in line.split()]
                start_y.append(Start_y[0])
        filename3 = '/home/sdcnlab/DRL_Path_QCar_MY/src/tf_pkg/scripts/12_goal_point_x.txt'
        with open(filename3, 'r') as f:
            lines = f.readlines()
            for line in lines:
                Goal_x = [float(s) for s in line.split()]
                goal_x.append(Goal_x[0])
        filename4 = '/home/sdcnlab/DRL_Path_QCar_MY/src/tf_pkg/scripts/12_goal_point_y.txt'
        with open(filename4, 'r') as f:
            lines = f.readlines()
            for line in lines:
                Goal_y = [float(s) for s in line.split()]
                goal_y.append(Goal_y[0])  
        filename5 = '/home/sdcnlab/DRL_Path_QCar_MY/src/tf_pkg/scripts/12_randangle.txt'
	    ...
	    if msgs_too_old:
	        ...
	        cmd_vel.drive.speed = self.v_last
	        cmd_vel.drive.steering_angle = self.w_last
	    ...
	    env.step(cmd)           
            ...
            if terminal == True:
                ...
                np.savetxt('/home/sdcnlab/DRL_Path_QCar_MY/src/tf_pkg/scripts/test_empty_world_30m_results/image_add_sensor/10_D3QN_PER_image_add_sensor_empty_world_30m_test_JACKAL_PATH_x'+'_'+str(i)+'.txt', JACKAL_x, delimiter=',')
                np.savetxt('/home/sdcnlab/DRL_Path_QCar_MY/src/tf_pkg/scripts/test_empty_world_30m_results/image_add_sensor/10_D3QN_PER_image_add_sensor_empty_world_30m_test_JACKAL_PATH_y'+'_'+str(i)+'.txt', JACKAL_y, delimiter=',')
                jackal_x  = []
                jackal_y  = []
                ...
                np.savetxt('/home/sdcnlab/DRL_Path_QCar_MY/src/tf_pkg/scripts/test_empty_world_30m_results/image_add_sensor/reward_pic/10_D3QN_PER_image_add_sensor_empty_world_30m_reward_test.txt', reward_array, delimiter=',')
