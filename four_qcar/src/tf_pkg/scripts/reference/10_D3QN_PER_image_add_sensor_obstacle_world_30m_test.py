...
class DQN:
    ...
    def main(self):
        ...
        filename1 = '/home/dell/DRL_Path_Planning/src/tf_pkg/scripts/14_static_obstacle_start_point_x.txt'
        with open(filename1, 'r') as f:
            lines = f.readlines()
            for line in lines:
                Start_x = [float(s) for s in line.split()]
                start_x.append(Start_x[0])
        filename2 = '/home/dell/DRL_Path_Planning/src/tf_pkg/scripts/14_static_obstacle_start_point_y.txt'
        with open(filename2, 'r') as f:
            lines = f.readlines()
            for line in lines:
                Start_y = [float(s) for s in line.split()]
                start_y.append(Start_y[0])
        filename3 = '/home/dell/DRL_Path_Planning/src/tf_pkg/scripts/14_static_obstacle_goal_point_x.txt'
        with open(filename3, 'r') as f:
            lines = f.readlines()
            for line in lines:
                Goal_x = [float(s) for s in line.split()]
                goal_x.append(Goal_x[0])
        filename4 = '/home/dell/DRL_Path_Planning/src/tf_pkg/scripts/14_static_obstacle_goal_point_y.txt'
        with open(filename4, 'r') as f:
            lines = f.readlines()
            for line in lines:
                Goal_y = [float(s) for s in line.split()]
                goal_y.append(Goal_y[0])  
        filename5 = '/home/dell/DRL_Path_Planning/src/tf_pkg/scripts/14_static_obstacle_randangle.txt'
        ...
        # 读取障碍
        filename = '/home/dell/DRL_Path_Planning/src/tf_pkg/scripts/14_static_obstacle_obs_pos_x.txt'
        with open(filename, 'r') as f:
            ...
            for line in lines:
                ...
                i += 1
        filename = '/home/dell/DRL_Path_Planning/src/tf_pkg/scripts/14_static_obstacle_obs_pos_y.txt'
        with open(filename, 'r') as f:
            lines = f.readlines()
            i = 0
            for line in lines:
        ...
        while True:
            ...
            if terminal == True:
                ...
                np.savetxt('/home/dell/DRL_Path_Planning/src/tf_pkg/scripts/10_D3QN_PER_image_add_sensor_obstacle_world_30m_test_JACKAL_PATH_x'+'_'+str(i)+'.txt', JACKAL_x, delimiter=',')
                np.savetxt('/home/dell/DRL_Path_Planning/src/tf_pkg/scripts/10_D3QN_PER_image_add_sensor_obstacle_world_30m_test_JACKAL_PATH_y'+'_'+str(i)+'.txt', JACKAL_y, delimiter=',')
                jackal_x  = []
                jackal_y  = []
                ...
                # 第一次训练
                np.savetxt('/home/dell/DRL_Path_Planning/src/tf_pkg/scripts/10_D3QN_PER_image_add_sensor_obstacle_world_30m_reward_test.txt', reward_array, delimiter=',')
                # 第二次训练
