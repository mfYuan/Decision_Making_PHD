...
class DQN:
    def __init__(self):
        ...
        # Initial parameters
        # ------------------------------
        self.Num_start_training = 900#5000
        ...
        self.load_path = '/home/sdcnlab/DRL_Path_Planning/src/tf_pkg/scripts/saved_networks/10_D3QN_PER_image_add_sensor_empty_world_30m_2020-10-13_test1'
    ...
    def network(self):
        ...
        # Input------image
        self.x_image = tf.compat.v1.placeholder(tf.float32, shape=[None, self.img_size, self.img_size, self.Num_stackFrame])
        ...
        with tf.compat.v1.variable_scope('target'):
            ...
            rnn_out_target, rnn_state_target = tf.compat.v1.nn.static_rnn(inputs = self.x_unstack, cell = cell_target, dtype = tf.float32)
