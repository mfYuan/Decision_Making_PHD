...
class D3QN_NoPER:
    def __init__(self):
        ...
        #self.load_path = '/home/sdcnlab025/ROS_test/four_qcar/src/tf_pkg/Revision testing/saved_networks/two_qcar_links_2021-11-10_train1-D3QN_PER/qcar1/9300' #NEW D3QN PER 1
	#self.load_path = '/home/sdcnlab025/ROS_test/four_qcar/src/tf_pkg/Revision testing/saved_networks/two_qcar_links_2021-11-10_train1-D3QN_PER/qcar1/8350' #NEW D3QN_PER_2
        self.load_path = '/home/sdcnlab025/ROS_test/four_qcar/src/tf_pkg/Revision testing/saved_networks/two_qcar_links_2021-11-11-D3QN_NoPER/qcar1/9500'
    ...
    def update_model(self, level):
        with graph1.as_default():
            ...
            # Load level 1 model
            if self.level == "1":
                self.saver.restore(self.sess1, self.load_path1 + "/model.ckpt")
            # Load level 2 model
            elif self.level == "2":
                self.saver.restore(self.sess1, self.load_path2 + "/model.ckpt")
            else:
                self.level = "3"
                self.saver.restore(self.sess1, self.load_path + "/model.ckpt")
