...
class DQN:
    ...
    def select_path(self):
        ...
        print('car2:{}, car1:{}, car3:{}, car4:{}'.format(car2_path, car1_path, car3_path, car4_path))
        return [car2_path, car1_path, car3_path, car4_path]
    ...
    def main(self):
        ...
        test_count = 0
        Driver_level = [2, 1, 0, 2] #0-l0, 1-adp,3 conservative, 
