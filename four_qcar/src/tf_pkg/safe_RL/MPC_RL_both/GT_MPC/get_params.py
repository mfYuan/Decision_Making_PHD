...
def get_params():
    ...
    params = Bunch(
                ...
                v_max = 5.0/36.0,     # (m/s) maximum car speed 
                v_min = 0.0/36.0,      # (m/s) minimum car speed
                t_step_DT = 0.65,     # (s) 
                t_step_DT_2 = 0.65,   # (s)  # move blocked
                t_step_Sim = 0.65,    # (s)             #0.25
                ...
                fps = 3,
                sim_case = 1,
                l_car_safe_fac = 1.6, # 1.1 ratio of length
    ...
    KDtrees_bound_3456 = {}
    for k in range(3, 7):
        KDtrees_bound_3456[str(k)] = cKDTree(intersection[str(k)])

    params.inter = intersection
    params.inter_tree = KDtrees_bound_3456
    return params