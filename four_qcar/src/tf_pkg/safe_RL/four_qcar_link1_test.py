...
class DQN1:
    def __init__(self):
        ...
        #self.load_path2 = '/home/sdcnlab025/ROS_test/four_qcar/src/tf_pkg/Revision testing/saved/Level-2/qcar1/5850' #Level2
        self.load_path1 = '/home/sdcnlab025/ROS_test/four_qcar/src/tf_pkg/Revision testing/saved/Adapative/qcar1/4050'  # Level1-New
        self.load_path2 = '/home/sdcnlab025/ROS_test/four_qcar/src/tf_pkg/Revision testing/saved/Adapative/qcar1/4050' #Level2
        self.load_path = '//home/sdcnlab025/ROS_test/four_qcar/src/tf_pkg/Revision testing/saved/Adapative/qcar1/4050' # ADP


	#self.load_path = '/home/sdcnlab025/ROS_test/four_qcar/src/tf_pkg/Revision testing/saved_networks/two_qcar_links_2021-11-10_train1-D3QN_PER/qcar1/9050' #NEW D3QN_PER_3
    ...
    def init_sess(self):
        with graph1.as_default():
            ...
            saver.restore(sess1, self.load_path1 + "/model.ckpt")
            print("Link 1 model restored : Level1")
