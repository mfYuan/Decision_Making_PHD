            ...
            for dist_id_1 in range(0, len(dist_comb)): # for each disturbance combination
                ...
                for id_2 in range(0, action_space.size):
                    for dist_id_2 in range(0, len(dist_comb)):
                        ...
                        #     for dist_id_3 in range(0, len(dist_comb)):
                        #         k = 2
                        #         X_old2 = Buffer[k]
                        #         X_new2, R22 = environment.environment(X_old1, car_id, id_2, t_step_DT, params, dist_id_2, Level_ratio)

                                # for id_4 in range(0, action_space.size):
                                #     for dist_id_4 in range(0, len(dist_comb)):
                                #         k = 2
                                #         X_old2 = Buffer[k]
                                #         X_new2, R22 = environment.environment(X_old1, car_id, id_2, t_step_DT, params, dist_id_2, Level_ratio)
                                        # for id_5 in range(0, action_space.size):
                                        #     for dist_id_5 in range(0, len(dist_comb)):
                                        #         k = 2
                                        #         X_old2 = Buffer[k]
                                        #         X_new2, R22 = environment.environment(X_old1, car_id, id_2, t_step_DT, params, dist_id_2, Level_ratio)
