...
class envmodel2():
    def __init__(self):
        ...
        self.idx = rospy.Subscriber('idx8', PoseStamped, self.idx_cb)
        # subscribers
    ...
    def resetval(self):
        ...
        self.d_2_4 = 0.0					# distance between qcar2 and qcar3
    ...
    def getreward(self):
        ...
        if (self.d_1_2 - self.d_1_2_last) < 0 and self.d_1_2 < 0.35 and self.robotstate2[2] > 0:
            reward = reward - 0.1
            print('Too close qcar1 and Apporaching reward lose 0.1')
        if (self.d_2_3 - self.d_2_3_last) < 0 and self.d_2_3 < 0.35 and self.robotstate2[2] > 0:
            reward = reward - 0.1
            print('Too close qcar3 and Apporaching reward lose 0.1')
        if (self.d_2_4 - self.d_2_4_last) < 0 and self.d_2_4 < 0.35 and self.robotstate2[2] > 0:
            reward = reward - 0.1
    ...
    def get_env(self):
        ...
        if self.done_list == False:
            if self.d_1_2 >= 0.2 and self.d_2_3 >= 0.2 and self.d_2_4 >= 0.2:
                self.done_list = False  # 不终止
            else:
