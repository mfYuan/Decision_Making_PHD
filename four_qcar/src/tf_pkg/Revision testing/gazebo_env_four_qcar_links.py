...
class envmodel():
    ...
    def return_position(self):
        return [self.robotstate1[0], self.robotstate1[1],self.robotstate2[0],self.robotstate2[1]
                ,self.robotstate3[0],self.robotstate3[1], self.robotstate4[0],self.robotstate4[1]]
