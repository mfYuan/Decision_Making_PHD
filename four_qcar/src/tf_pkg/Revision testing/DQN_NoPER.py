...
class DQN_NoPER:
    def __init__(self):
        ...
        self.Number = 'DQN_NoPER'
        # self.Number='test2'
        # Get parameters
        self.progress = ''
        self.Num_action = len(qcar1_dict)
        # self.load_path = '/home/sdcnlab025/ROS_test/four_qcar/src/tf_pkg/scripts/saved_networks/two_qcar_links_2021-07-25_train1/qcar1/8500' #Level3
        # self.load_path = '/home/sdcnlab025/ROS_test/four_qcar/src/tf_pkg/scripts/saved_networks/two_qcar_links_2021-07-29_train1/qcar1/4250' #Level1-Easy
        # self.load_path = '/home/sdcnlab025/ROS_test/four_qcar/src/tf_pkg/scripts/saved_networks/two_qcar_links_2021-07-30_train1/qcar1/5150' #Level1-preH
        ...
        #self.load_path = '/home/sdcnlab025/ROS_test/four_qcar/src/tf_pkg/scripts/saved_networks/two_qcar_links_2021-08-04_train1/qcar1/6350'  # Level1-New
        # self.load_path = '/home/sdcnlab025/ROS_test/four_qcar/src/tf_pkg/scripts/saved_networks/two_qcar_links_2021-08-07_train1/qcar1/5850' # level2-New
        # self.load_path = '/home/sdcnlab025/ROS_test/four_qcar/src/tf_pkg/scripts/saved_networks/two_qcar_links_2021-08-09_train1/qcar1/4050' # Adp-New
        # self.load_path = '/home/sdcnlab025/ROS_test/four_qcar/src/tf_pkg/scripts/saved_networks/two_qcar_links_2021-08-21_train1/qcar1/4750' #Level1Nolidar
	self.load_path = '/home/sdcnlab025/ROS_test/four_qcar/src/tf_pkg/Revision testing/saved_networks/two_qcar_links_2021-11-15_train1-DQN_NoPER/qcar1/9400'
        self.step = 1
        self.score = 0
        self.episode = 0
    ...
    def network(self):
        ...
        with graph1.as_default():
            ...
            self.x_sensor = tf.placeholder(
                tf.float32, shape=[None, self.Num_stackFrame, self.Num_dataSize],name='sensor')
		...
		h_conv3 = tf.nn.relu(self.conv2d(h_conv2, w_conv3, 1) + b_conv3)'''
            ...
            with tf.variable_scope('target'):
                ...
                w1_target = self.weight_variable(
                    self.first_dense)  # w_fc1_1 = ([6400,512])
                b1_target = self.bias_variable(
                    [self.first_dense[1]])  # b_fc1_1 = ([512])

                w2_target = self.weight_variable(
                    self.second_dense_action)  # w_fc2_2 = ([512，5])
                b2_target = self.bias_variable(
                    [self.second_dense_action[1]])  # b_fc2_2 = ([5])
		...
		h_fc1_action_target = tf.matmul(h_concat_target, w_fc1_2_target)+b_fc1_2_target'''
            l1_target = tf.matmul(rnn_out_target, w1_target)+b1_target
            output_target = tf.matmul(l1_target, w2_target) + b2_target
    ...
    def loss_and_train(self):
        with graph1.as_default():
            ...
            action_target = tf.placeholder(
                tf.float32, shape=[None, self.Num_action], name="action_target")
            ...
            ################################################### PER ############################################################
            w_is = tf.placeholder(tf.float32, shape=[None], name="w_is")
	    ...
	    Q_target = self.output_target.eval(
            ...
            for i in range(len(minibatch)):
                if terminal_batch[i] == True:
                    ...
                    y_batch.append(
                        reward_batch[i] + self.Gamma * np.max(Q_target[i]))
    ...
    def update_information(self):
        ...
        collision = env_info[-4]
        dangerzone = env_info[-3]
        ...
        return terminal, collision, dangerzone
