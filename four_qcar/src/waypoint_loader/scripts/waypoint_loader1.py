...
class WaypointLoader(object):
    ...
    def __init__(self):
        rospy.init_node('waypoint_loader1', log_level=rospy.DEBUG)

        self.pub = rospy.Publisher('/base_waypoints1', Lane, queue_size=1, latch=True)
        self.pub_path = rospy.Publisher('/base_path1', Path, queue_size=1, latch=True)
